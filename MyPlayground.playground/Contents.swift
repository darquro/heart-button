...
class MyViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.heartButton = HeartButton(frame: CGRect(x: 0, y: 0, width: 100, height: 100))
...
//        self.heartButton?.changeState(isOn: true, animated: true)
        let button = UIButton(frame: CGRect(x: 0, y: 150, width: 180, height: 50))
        button.titleLabel?.text = "changeState"
